...
function TEN_normalTenkey() {//생성자함수
    ...
    this.evt = function(){
        ...
        if(tenClass.shuffle==1 || tenClass.shuffle==5){
            shuffleP = 3;
        ...
        if(this.allDimdF==1){
            ...
            if(this.screenNumber == "KR2031"){ // 국민은행 시재관리기 통신사선택
                this.confirmDimd(1);
            }
            else{
                this.confirmDimd(0);
        ...
        let shuffleF = tenClass.shuffle===1?this.keyDraw():tenClass.shuffle===4?this.keyRandom():tenClass.shuffle===4?this.test():"";
        ...
        if(spFlag){//////////////connectF가 true시 즉 tenCall함수 사용해야 하는 상황
            ...
            switch(pageFlag){
                case spName+'2102':   
                    ...
                    //}
                break;
                case spName+'2031': // 국민은행 시재관리기 통신사 선택
                    btnArr[confirmNumber].breturn = "=[" + tenObj.outReturnG + this.tmpGab + "]";
                break;
                default:
                    btnArr[confirmNumber].breturn = "=[" + this.tmpGab + "]";
                break;
