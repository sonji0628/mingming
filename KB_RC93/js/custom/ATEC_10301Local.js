...
for (var i = 0; i < cmArr.length; i++) {
	if(cmArr[i].class == "10301Local") { //요기 바꿔주고
		cmArr[i].jsObj = new ATEC_10301Local(Number(cmArr[i].index)); //요기 바꿔주고
		cmArr[i].jsObj.evt();
